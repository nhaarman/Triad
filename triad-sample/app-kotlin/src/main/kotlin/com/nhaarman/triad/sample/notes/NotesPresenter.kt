...
internal class NotesPresenter(private val triad: Triad) :
      BasePresenter<NotesContainer, ActivityComponent>(), NotesListPresenter.OnNoteClickedListener {

    fun onCreateNoteClicked() {
        triad.goTo(EditNoteScreen(), TranslateLeftAnimator())
    }

    override fun onNoteClicked(note: Note) {
        triad.goTo(EditNoteScreen(note))
    }
}
