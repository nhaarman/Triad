...
public class ForwardScreenTransitionTest extends TestActivityInstrumentationTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    waitUntil(viewNotPresent(mScreenHolder, R.id.view_screen_first));
  }

  public void test_afterTransition_viewsHaveBeenSwitched() throws InterruptedException {
    assertThat(mScreenHolder.findViewById(R.id.view_screen_second), is(not(nullValue())));
    assertThat(mScreenHolder.findViewById(R.id.view_screen_first), is(nullValue()));
  }
